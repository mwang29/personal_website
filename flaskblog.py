...
posts = [
    {
        ...
        'content': ["One of my hobbies is competing in Super Smash Bros. Melee, a fighting game that released way back in 2001. Despite its age, it's still popular today thanks to a community of passionate gamers. At Purdue University, we have one of the strongest college Melee scenes in the country with 30-40 active players.",
                    "I know it sounds crazy, but this game has assuredly improved my life in multiple aspects. Melee gave me an outlet for my competitiveness and also a way to challenge myself to learn and improve. It's a great way to escape the stress of academics, and I've made many lifelong friends over the years.",
                    ...
                    "The traditional method of seeding is usually a trial-and-error approach where the tournament organizer would test out various combinations until one is deemed 'good enough'. I knew there was a better way and so I made a Google Sheet that automates most of the process. You can find it here. The tournament ran very smoothly and attendees were satisified with the seeding. I'm happy that future tournaments can reuse this tool to save time and energy that could be spent on other aspects of the tournament.",
